...
use super::setters::{
    ...
    set_confirm_before_rewind_inner, set_contextual_hint_inner, set_cursor_provider_enabled_inner,
...
pub(in crate::app::dispatch) fn action_for_reset(
    ...
    match (key, value) {
        ...
        ("cursor_provider_enabled", SettingValue::Bool(b)) => {
            Some(Action::SetCursorProviderEnabled(*b))
        }
...
pub(in crate::app::dispatch) fn apply_setting_rollback(
    ...
    match (key, rollback_value) {
        ...
        ("cursor_provider_enabled", SettingValue::Bool(b)) => {
            set_cursor_provider_enabled_inner(app, *b)
        }
